 ...
 *
 * This class manages the state for the marketplace view in the darbot-coder extensions interface.
 *
 * IMPORTANT: Fixed issue where the marketplace feature was causing the darbot-coder extensions interface
...
import { MarketplaceItem } from "@darbot-code/types"
...
export class MarketplaceViewStateManager {
	...
	public async handleMessage(message: any): Promise<void> {
		...
		if (message.type === "state") {
			...
			// The state.marketplaceItems come from DarbotProvider, see the file src/core/webview/DarbotProvider.ts
