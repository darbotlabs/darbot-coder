...
const tips = [
   {
      ...
      titleKey: "darbotTips.customizableModes.title",
      descriptionKey: "darbotTips.customizableModes.description",
   },
   {
      icon: "codicon-list-tree",
      href: buildDocLink("features/boomerang-tasks", "tips"),
      titleKey: "darbotTips.boomerangTasks.title",
      descriptionKey: "darbotTips.boomerangTasks.description",
   },
]

interface DarbotTipsProps {
   cycle?: boolean
}

const DarbotTips = ({ cycle = false }: DarbotTipsProps) => {
