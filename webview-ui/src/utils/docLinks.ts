/**
 * Utility for building darbot-coder documentation links with UTM telemetry.
 *
...
export function buildDocLink(path: string, campaign: string): string {
	...
	const baseUrl = `https://github.com/DarbotLabs/darbot-coder/blob/main/docs/${basePath}.md?utm_source=extension&utm_medium=ide&utm_campaign=${encodeURIComponent(campaign)}`
