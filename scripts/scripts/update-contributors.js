...
const GITHUB_API_URL = "https://api.github.com/repos/DarbotFramework/darbot-coder/contributors?per_page=100"
...
const options = {
	headers: {
		"User-Agent": "Darbot-Coder-Contributors-Script",
	},
}
...
const EXCLUDED_LOGIN_EXACTS = ['cursor', 'darbot'];

function formatContributorsSection(contributors) {
	// Filter out GitHub Actions bot, cursor, and darbot
