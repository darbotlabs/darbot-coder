...
Clone the Darbot Code repo:

```sh
git clone https://github.com/DarbotCodeInc/Darbot-Code.git
cd Darbot-Code
```
...
By default a evals run will run all programming exercises in [Darbot Code Evals](https://github.com/DarbotCodeInc/Darbot-Code-Evals) repository with the Claude Sonnet 4 model and default settings. For basic configuration you can specify the LLM to use and any subset of the exercises you'd like. For advanced configuration you can import a Darbot Code settings file which will allow you to run the evals with Darbot Code configured any way you'd like (this includes custom modes, a footgun prompt, etc).
...
- Installs programming languages: Node.js 20.x LTS, Python 3.13.2, Go 1.24.2, Rust 1.85.1, Java 17
...
- Optionally builds and installs the Darbot Code extension from source
