...
- **Environment Setup**: Launches VS Code with darbot extension in isolated container
...
- **Development Tools**: VS Code with language-specific extensions and darbot-coder extension
