...
export interface DarbotCodeAPI extends EventEmitter<DarbotCodeAPIEvents> {
	/**
	 ...
	 * @returns The current configuration.
	 */
	getConfiguration(): DarbotCodeSettings
	/**
	 * Sets the configuration for the current task.
	 * @param values An object containing key-value pairs to set.
	 */
	setConfiguration(values: DarbotCodeSettings): Promise<void>
	/**
...
export interface DarbotCodeIpcServer extends EventEmitter<IpcServerEvents> {
	listen(): void
