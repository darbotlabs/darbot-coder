...
export function ContactForm({ formType, buttonText, buttonClassName }: ContactFormProps) {
	...
	const formDescription =
		formType === "early-access"
			? "Fill out the form below to collaborate in shaping darbot-coder's enterprise solution."
			: "Fill out the form below to see darbot-coder's enterprise capabilities in action."
