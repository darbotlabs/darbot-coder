...
export const metadata: Metadata = {
	title: "Terms of Service - Darbot Labs",
	description:
		"Terms of Service for Darbot Labs Cloud. Learn about our service terms, commercial conditions, and legal framework.",
}
			...
			<div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8">
				<div className="prose prose-lg mx-auto max-w-4xl dark:prose-invert">
					<h1 className="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">
						Darbot Labs Cloud Terms of Service
					</h1>
					...
					<p className="lead">
						These Terms of Service (&quot;<strong>TOS</strong>&quot;) govern access to and use of the Darbot
					...
					<ul className="lead">
						<li>
							...
							executed by Darbot Labs and the customer that references these TOS; <strong>and</strong>
						</li>
						<li>
							<strong>(b)</strong> any{" "}
					...
					<p>
						If Darbot Labs and Customer later execute a Master Subscription Agreement (&quot;
						...
						<table className="min-w-full border-collapse border border-border">
							...
							<tbody>
								...
								<tr className="bg-muted/25">
									...
									<td className="border border-border px-4 py-2">
										Darbot Labs maintains commercially reasonable administrative, physical, and
								...
								<tr>
									...
									<td className="border border-border px-4 py-2">
										Darbot Labs <strong>does not</strong> use Customer Content to train, fine-tune, or
								...
								<tr>
									...
									<td className="border border-border px-4 py-2">
										Darbot Labs may identify Customer (name & logo) in marketing materials unless
					...
					<ol>
						...
						<li>
							...
							<br />
							Deleted – Darbot Labs offers no trials, pilots, betas, or SLA credits under these TOS.
						</li>
						<li>
					...
					<p>
						Darbot Labs&apos;s Privacy Notice (
						<a
							href="https://github.com/DarbotLabs/darbot-coder/blob/main/docs/privacy.md"
							rel="noopener noreferrer"
							className="text-primary hover:underline">
							https://github.com/DarbotLabs/darbot-coder/blob/main/docs/privacy.md
						</a>
						) explains how Darbot Labs collects and handles personal information. For questions,
					...
					<ol>
						<li>
							...
							<br />
							Customer may not assign the Agreement without Darbot Labs&apos;s prior written consent, except
						...
						<li>
							...
							<br />
							Darbot Labs may update these TOS by posting a revised version at the same URL and emailing or
					...
					<p>
						<strong>Darbot Labs</strong>
						<br />
						For questions or support, please create an issue on our{" "}
