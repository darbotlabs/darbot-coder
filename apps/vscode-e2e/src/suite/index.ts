...
import type { DarbotCodeAPI } from "@darbot-code/types"

import { waitFor } from "./utils"

export async function run() {
	const extension = vscode.extensions.getExtension<DarbotCodeAPI>("DarbotLabs.darbot-coder")
	...
	await vscode.commands.executeCommand("darbot-coder.SidebarProvider.focus")
