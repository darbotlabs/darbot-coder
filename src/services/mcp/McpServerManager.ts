...
export class McpServerManager {
	...
	private static providers: Set<DarbotProvider> = new Set()
	 ...
	 */
	static async getInstance(context: vscode.ExtensionContext, provider: DarbotProvider): Promise<McpHub> {
	 ...
	 */
	static unregisterProvider(provider: DarbotProvider): void {
