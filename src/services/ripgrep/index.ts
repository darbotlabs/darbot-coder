...
export async function regexSearchFiles(
	...
	// Filter results using DarbotIgnoreController if provided
	const filteredResults = darbotIgnoreController
		? results.filter((result) => darbotIgnoreController.validateAccess(result.file))
		: results
