...
export class DirectoryScanner implements IDirectoryScanner {
	 ...
	 * @param darbotIgnoreController Optional DarbotIgnoreController instance for filtering
	...
	public async scanDirectory(
		...
		// Initialize DarbotIgnoreController if not provided
		const ignoreController = new DarbotIgnoreController(directoryPath)

		await ignoreController.initialize()

		// Filter paths using .darbotignore
