...
import type { DarbotTerminalProcess, DarbotTerminalProcessEvents, ExitCodeDetails } from "./types"

export abstract class BaseTerminalProcess extends EventEmitter<DarbotTerminalProcessEvents> implements DarbotTerminalProcess {
	...
	// of before sending request to darbot-coder.
