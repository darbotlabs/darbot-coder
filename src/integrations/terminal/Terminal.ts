...
import type { DarbotTerminalCallbacks, DarbotTerminalProcessResultPromise } from "./types"
...
export class Terminal extends BaseTerminal {
	...
	constructor(id: number, terminal: vscode.Terminal | undefined, cwd: string) {
		...
		this.terminal = terminal ?? vscode.window.createTerminal({ cwd, name: "darbot-coder", iconPath, env })
	...
	public override runCommand(command: string, callbacks: DarbotTerminalCallbacks): DarbotTerminalProcessResultPromise {
