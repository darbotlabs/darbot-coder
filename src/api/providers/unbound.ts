...
import { unboundDefaultModelId, unboundDefaultModelInfo } from "@darbot-code/types"
...
const ORIGIN_APP = "darbot-coder"

const DEFAULT_HEADERS = {
	"X-Unbound-Metadata": JSON.stringify({ labels: [{ key: "app", value: "darbot-coder" }] }),
}
