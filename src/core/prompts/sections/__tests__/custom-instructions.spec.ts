...
describe("loadRuleFiles", () => {
	...
	it("should read and trim file content", async () => {
		// Simulate no .darbot/rules directory
	...
	it("should use .darbot/rules/ directory when it exists and has files", async () => {
		// Simulate .darbot/rules directory exists
		...
		readdirMock.mockResolvedValueOnce([
			{ name: "file1.txt", isFile: () => true, isSymbolicLink: () => false, parentPath: "/fake/path/.darbot/rules" },
			{ name: "file2.txt", isFile: () => true, isSymbolicLink: () => false, parentPath: "/fake/path/.darbot/rules" },
		] as any)
		...
		statMock.mockImplementation((path) => {
			...
			if (
				normalizedPath.includes("/fake/path/.darbot/rules/file1.txt") ||
				normalizedPath.includes("/fake/path/.darbot/rules/file2.txt")
			) {
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			...
			if (normalizedPath === "/fake/path/.darbot/rules/file1.txt") {
				return Promise.resolve("content of file1")
			}
			if (normalizedPath === "/fake/path/.darbot/rules/file2.txt") {
		...
		const result = await loadRuleFiles("/fake/path")
		const expectedPath1 =
			process.platform === "win32" ? "\\fake\\path\\.darbot\\rules\\file1.txt" : "/fake/path/.darbot/rules/file1.txt"
		const expectedPath2 =
			process.platform === "win32" ? "\\fake\\path\\.darbot\\rules\\file2.txt" : "/fake/path/.darbot/rules/file2.txt"
		...
		const expectedRulesDir = process.platform === "win32" ? "\\fake\\path\\.darbot\\rules" : "/fake/path/.darbot/rules"
	...
	it("should filter out cache files from .darbot/rules/ directory", async () => {
		// Simulate .darbot/rules directory exists
		statMock.mockResolvedValueOnce({
			isDirectory: vi.fn().mockReturnValue(true),
		} as any)
		...
		readdirMock.mockResolvedValueOnce([
			{ name: "rule1.txt", isFile: () => true, isSymbolicLink: () => false, parentPath: "/fake/path/.darbot/rules" },
			{ name: ".DS_Store", isFile: () => true, isSymbolicLink: () => false, parentPath: "/fake/path/.darbot/rules" },
			{ name: "Thumbs.db", isFile: () => true, isSymbolicLink: () => false, parentPath: "/fake/path/.darbot/rules" },
			{ name: "rule2.md", isFile: () => true, isSymbolicLink: () => false, parentPath: "/fake/path/.darbot/rules" },
			{ name: "cache.log", isFile: () => true, isSymbolicLink: () => false, parentPath: "/fake/path/.darbot/rules" },
			{
				name: "backup.bak",
				isFile: () => true,
				isSymbolicLink: () => false,
				parentPath: "/fake/path/.darbot/rules",
			},
			{ name: "temp.tmp", isFile: () => true, isSymbolicLink: () => false, parentPath: "/fake/path/.darbot/rules" },
			{
				name: "script.pyc",
				isFile: () => true,
				isSymbolicLink: () => false,
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			...
			if (normalizedPath === "/fake/path/.darbot/rules/rule1.txt") {
				return Promise.resolve("rule 1 content")
			}
			if (normalizedPath === "/fake/path/.darbot/rules/rule2.md") {
			...
			if (normalizedPath === "/fake/path/.darbot/rules/.DS_Store") {
				return Promise.resolve("DS_STORE_BINARY_CONTENT")
			}
			if (normalizedPath === "/fake/path/.darbot/rules/Thumbs.db") {
				return Promise.resolve("THUMBS_DB_CONTENT")
			}
			if (normalizedPath === "/fake/path/.darbot/rules/backup.bak") {
				return Promise.resolve("BACKUP_CONTENT")
			}
			if (normalizedPath === "/fake/path/.darbot/rules/cache.log") {
				return Promise.resolve("LOG_CONTENT")
			}
			if (normalizedPath === "/fake/path/.darbot/rules/temp.tmp") {
				return Promise.resolve("TEMP_CONTENT")
			}
			if (normalizedPath === "/fake/path/.darbot/rules/script.pyc") {
		...
		const expectedCacheFiles = [
			"/fake/path/.darbot/rules/.DS_Store",
			"/fake/path/.darbot/rules/Thumbs.db",
			"/fake/path/.darbot/rules/backup.bak",
			"/fake/path/.darbot/rules/cache.log",
			"/fake/path/.darbot/rules/temp.tmp",
			"/fake/path/.darbot/rules/script.pyc",
		]
	...
	it("should fall back to .darbotrules when .darbot/rules/ is empty", async () => {
		// Simulate .darbot/rules directory exists
		statMock.mockResolvedValueOnce({
			isDirectory: vi.fn().mockReturnValue(true),
		} as any)
	...
	it("should read files from nested subdirectories in .darbot/rules/", async () => {
		...
		readdirMock.mockResolvedValueOnce([
			...
			},
			{
				...
				isSymbolicLink: () => false,
				isDirectory: () => false,
				parentPath: "/fake/path/.darbot/rules/subdir",
			},
			{
				name: "nested2.txt",
				isFile: () => true,
				isSymbolicLink: () => false,
				isDirectory: () => false,
				parentPath: "/fake/path/.darbot/rules/subdir/subdir2",
			},
		] as any)
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			...
			// Handle both Unix and Windows path separators
			const normalizedPath = pathStr.replace(/\\/g, "/")
			if (normalizedPath === "/fake/path/.darbot/rules/root.txt") {
				return Promise.resolve("root file content")
			}
			if (normalizedPath === "/fake/path/.darbot/rules/subdir/nested1.txt") {
				return Promise.resolve("nested file 1 content")
			}
			if (normalizedPath === "/fake/path/.darbot/rules/subdir/subdir2/nested2.txt") {
		...
		const expectedRootPath =
			process.platform === "win32" ? "\\fake\\path\\.darbot\\rules\\root.txt" : "/fake/path/.darbot/rules/root.txt"
		const expectedNested1Path =
			process.platform === "win32"
				? "\\fake\\path\\.darbot\\rules\\subdir\\nested1.txt"
				: "/fake/path/.darbot/rules/subdir/nested1.txt"
		const expectedNested2Path =
			process.platform === "win32"
				? "\\fake\\path\\.darbot\\rules\\subdir\\subdir2\\nested2.txt"
				: "/fake/path/.darbot/rules/subdir/subdir2/nested2.txt"
...
describe("addCustomInstructions", () => {
	...
	it("should combine all instruction types when provided", async () => {
		// Simulate no .darbot/rules-test-mode directory
		statMock.mockRejectedValueOnce({ code: "ENOENT" })
	...
	it("should use .darbot/rules-test-mode/ directory when it exists and has files", async () => {
		// Simulate .darbot/rules-test-mode directory exists
		statMock.mockResolvedValueOnce({
			isDirectory: vi.fn().mockReturnValue(true),
		} as any)
		...
		readdirMock.mockResolvedValueOnce([
			{
				...
				isFile: () => true,
				isSymbolicLink: () => false,
				parentPath: "/fake/path/.darbot/rules-test-mode",
			},
			{
				name: "rule2.txt",
				isFile: () => true,
		...
		statMock.mockImplementation((path) => {
			...
			const normalizedPath = path.toString().replace(/\\/g, "/")
			if (
				normalizedPath.includes("/fake/path/.darbot/rules-test-mode/rule1.txt") ||
				normalizedPath.includes("/fake/path/.darbot/rules-test-mode/rule2.txt")
			) {
				return Promise.resolve({
					isFile: vi.fn().mockReturnValue(true),
				}) as any
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			...
			// Handle both Unix and Windows path separators
			const normalizedPath = pathStr.replace(/\\/g, "/")
			if (normalizedPath === "/fake/path/.darbot/rules-test-mode/rule1.txt") {
				return Promise.resolve("mode specific rule 1")
			}
			if (normalizedPath === "/fake/path/.darbot/rules-test-mode/rule2.txt") {
		...
		const expectedTestModeDir =
			process.platform === "win32" ? "\\fake\\path\\.darbot\\rules-test-mode" : "/fake/path/.darbot/rules-test-mode"
		const expectedRule1Path =
			process.platform === "win32"
				? "\\fake\\path\\.darbot\\rules-test-mode\\rule1.txt"
				: "/fake/path/.darbot/rules-test-mode/rule1.txt"
		const expectedRule2Path =
			process.platform === "win32"
				? "\\fake\\path\\.darbot\\rules-test-mode\\rule2.txt"
				: "/fake/path/.darbot/rules-test-mode/rule2.txt"
	...
	it("should fall back to .darbotrules-test-mode when .darbot/rules-test-mode/ does not exist", async () => {
		// Simulate .darbot/rules-test-mode directory does not exist
		statMock.mockRejectedValueOnce({ code: "ENOENT" })

		// Simulate .darbotrules-test-mode exists
		readFileMock.mockImplementation((filePath: PathLike) => {
			if (filePath.toString().includes(".darbotrules-test-mode")) {
	...
	it("should correctly format content from directories when using .darbot/rules-test-mode/", async () => {
		...
		readdirMock.mockResolvedValueOnce([
			{ name: "rule1.txt", isFile: () => true, parentPath: "/fake/path/.darbot/rules-test-mode" },
		] as any)
		readFileMock.mockReset()
...
describe("Rules directory reading", () => {
	it.skipIf(process.platform === "win32")("should follow symbolic links in the rules directory", async () => {
		...
		readdirMock
			...
			.mockResolvedValueOnce([
				{ name: "subdir_link.txt", isFile: () => true, parentPath: "/fake/path/.darbot/rules/symlink-target-dir" },
			] as any)
		...
		statMock.mockImplementation((path: string) => {
			// For directory check
			if (path === "/fake/path/.darbot/rules" || path.endsWith("dir")) {
				return Promise.resolve({
					isDirectory: vi.fn().mockReturnValue(true),
					isFile: vi.fn().mockReturnValue(false),
				} as any)
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			...
			// Handle both Unix and Windows path separators
			const normalizedPath = pathStr.replace(/\\/g, "/")
			if (normalizedPath === "/fake/path/.darbot/rules/regular.txt") {
				return Promise.resolve("regular file content")
			}
			if (normalizedPath === "/fake/path/.darbot/symlink-target.txt") {
				return Promise.resolve("symlink target content")
			}
			if (normalizedPath === "/fake/path/.darbot/rules/symlink-target-dir/subdir_link.txt") {
				return Promise.resolve("regular file content under symlink target dir")
			}
			if (normalizedPath === "/fake/path/.darbot/nested-symlink-target.txt") {
		...
		const expectedRegularPath =
			process.platform === "win32"
				? "\\fake\\path\\.darbot\\rules\\regular.txt"
				: "/fake/path/.darbot/rules/regular.txt"
		const expectedSymlinkPath =
			process.platform === "win32"
				? "\\fake\\path\\.darbot\\symlink-target.txt"
				: "/fake/path/.darbot/symlink-target.txt"
		const expectedSubdirPath =
			process.platform === "win32"
				? "\\fake\\path\\.darbot\\rules\\symlink-target-dir\\subdir_link.txt"
				: "/fake/path/.darbot/rules/symlink-target-dir/subdir_link.txt"
		const expectedNestedPath =
			process.platform === "win32"
				? "\\fake\\path\\.darbot\\nested-symlink-target.txt"
				: "/fake/path/.darbot/nested-symlink-target.txt"
		...
		expect(readlinkMock).toHaveBeenCalledWith("/fake/path/.darbot/rules/link.txt")
		expect(readlinkMock).toHaveBeenCalledWith("/fake/path/.darbot/rules/link_dir")

		// Verify both files were read
		expect(readFileMock).toHaveBeenCalledWith("/fake/path/.darbot/rules/regular.txt", "utf-8")
		expect(readFileMock).toHaveBeenCalledWith("/fake/path/.darbot/symlink-target.txt", "utf-8")
		expect(readFileMock).toHaveBeenCalledWith("/fake/path/.darbot/rules/symlink-target-dir/subdir_link.txt", "utf-8")
		expect(readFileMock).toHaveBeenCalledWith("/fake/path/.darbot/nested-symlink-target.txt", "utf-8")
	})
	beforeEach(() => {
		vi.clearAllMocks()
	})
	...
	it.skipIf(process.platform === "win32")("should correctly format multiple files from directory", async () => {
		...
		// Simulate listing files
		readdirMock.mockResolvedValueOnce([
			{ name: "file1.txt", isFile: () => true, parentPath: "/fake/path/.darbot/rules" },
			{ name: "file2.txt", isFile: () => true, parentPath: "/fake/path/.darbot/rules" },
			{ name: "file3.txt", isFile: () => true, parentPath: "/fake/path/.darbot/rules" },
		] as any)
		...
		statMock.mockImplementation((path) => {
			...
			const normalizedPath = path.toString().replace(/\\/g, "/")
			expect([
				"/fake/path/.darbot/rules/file1.txt",
				"/fake/path/.darbot/rules/file2.txt",
				"/fake/path/.darbot/rules/file3.txt",
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			...
			if (normalizedPath === "/fake/path/.darbot/rules/file3.txt") {
		...
		const expectedFile3Path =
			process.platform === "win32" ? "\\fake\\path\\.darbot\\rules\\file3.txt" : "/fake/path/.darbot/rules/file3.txt"
