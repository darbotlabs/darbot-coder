...
describe("custom-instructions global .darbot support", () => {
	...
	describe("loadRuleFiles", () => {
		...
		it("should fall back to legacy .darbotrules file when no .darbot/rules directories exist", async () => {
			...
			expect(result).toContain("# Rules from .darbotrules:")
	...
	describe("addCustomInstructions mode-specific rules", () => {
		...
		it("should fall back to legacy mode-specific files when no mode directories exist", async () => {
			...
			expect(result).toContain("# Rules from .darbotrules-code:")
