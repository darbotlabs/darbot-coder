// npx vitest core/ignore/__tests__/DarbotIgnoreController.security.spec.ts

import type { Mock } from "vitest"

import { DarbotIgnoreController } from "../DarbotIgnoreController"
...
describe("DarbotIgnoreController Security Tests", () => {
	...
	beforeEach(async () => {
		...
		// By default, setup .darbotignore to exist with some patterns
