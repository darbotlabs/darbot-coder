...
export const recordSourceSchema = z.enum(["read_tool", "user_edited", "darbot_edited", "file_mentioned"])
...
export const fileMetadataEntrySchema = z.object({
	...
	darbot_read_date: z.number().nullable(),
	darbot_edit_date: z.number().nullable(),
