import type { TokenUsage, DarbotMessage } from "@darbot-code/types"
...
/**
 * Calculates API metrics from an array of DarbotMessages.
 *
 ...
 */
export function getApiMetrics(messages: DarbotMessage[]) {
